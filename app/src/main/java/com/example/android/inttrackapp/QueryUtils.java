...
/**
 * Helper methods related to requesting and receiving developer data from GitHub.
 */
public final class QueryUtils {
    ...
    /**
     * Query the GitHub dataset and return a list of {@link Developer} objects.
     */
    ...
    private static List<Developer> extractFeatureFromJson(String developerJSON) {
        ...
        try {
            ...
            for (int i = 0; i < itemsArray.length(); i++) {
                ...
                JSONObject currentDeveloper = itemsArray.getJSONObject(i);

                // For a given developer, extract the JSONObject associated with the
                // key called "items", which represents a list of all properties
                // for that developer.
                JSONObject items = currentDeveloper.getJSONObject("items");
                ...
                int imageResourceId = items.getInt("avatar_url");

                // Extract the value for the key called "url"
                String url = items.getString("url");

                // Create a new {@link Developer} object with the username, imageResource,
                // and url from the JSON response.
                Developer developer = new Developer(username, imageResourceId, url);
